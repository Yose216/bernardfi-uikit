...
var Icon$L = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/bones.png" })));
};

var Icon$M = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/barrel.png" })));
};

var Icon$N = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React__default['default'].createElement("image", { width: 90, height: 90, href: "/images/bern.png" })));
};
...
var Icon$1d = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 50 50" }, props),
        React__default['default'].createElement("path", { d: "M34,3H16C8.83,3,3,8.83,3,16v18c0,7.17,5.83,13,13,13h18c7.17,0,13-5.83,13-13V16C47,8.83,41.17,3,34,3z M25,36c-6.07,0-11-4.93-11-11s4.93-11,11-11s11,4.93,11,11S31.07,36,25,36z M37,15c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2S38.1,15,37,15z" }),
        React__default['default'].createElement("path", { d: "M34,25c0,4.96-4.04,9-9,9s-9-4.04-9-9s4.04-9,9-9S34,20.04,34,25z" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React__default['default'].createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React__default['default'].createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Bernardfinance home page" }, innerLogo)) : (React__default['default'].createElement(StyledLink$1, { to: href, "aria-label": "Bernardfinance home page" }, innerLogo))));
};
...
var PanelFooter = function (_a) {
    ...
    return (React__default['default'].createElement(Container$4, null,
        React__default['default'].createElement(SocialEntry, null,
            bernPriceUsd ? (React__default['default'].createElement(PriceLink, { href: bernPriceLink, target: "_blank" },
                React__default['default'].createElement(Icon$N, { width: "20px", mr: "5px" }),
                React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + bernPriceUsd.toFixed(2)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
            barrelPriceUsd ? (React__default['default'].createElement(PriceLink, { href: barrelPriceLink, target: "_blank" },
                React__default['default'].createElement(Icon$M, { width: "20px", mr: "5px", ml: "5px" }),
                React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + barrelPriceUsd.toFixed(2)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 })),
            bonesPriceUsd ? (React__default['default'].createElement(PriceLink, { href: bonesPriceLink, target: "_blank" },
                React__default['default'].createElement(Icon$L, { width: "20px", mr: "5px", ml: "5px" }),
                React__default['default'].createElement(Text, { color: "textSubtle", bold: true }, "$" + bonesPriceUsd.toFixed(2)))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
        React__default['default'].createElement(SocialEntry, null,
...
exports.BarrelRoundIcon = Icon$M;
exports.BaseLayout = GridLayout;
exports.BernRoundIcon = Icon$N;
exports.BinanceIcon = Icon$b;
exports.BlockIcon = Icon$2;
exports.BonesRoundIcon = Icon$L;
