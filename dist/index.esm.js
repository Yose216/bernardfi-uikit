...
var Icon$L = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/bones.png" })));
};

var Icon$M = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/barrel.png" })));
};

var Icon$N = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 90 90" }, props),
        React.createElement("image", { width: 90, height: 90, href: "/images/bern.png" })));
};
...
var Icon$1d = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 50 50" }, props),
        React.createElement("path", { d: "M34,3H16C8.83,3,3,8.83,3,16v18c0,7.17,5.83,13,13,13h18c7.17,0,13-5.83,13-13V16C47,8.83,41.17,3,34,3z M25,36c-6.07,0-11-4.93-11-11s4.93-11,11-11s11,4.93,11,11S31.07,36,25,36z M37,15c-1.1,0-2-0.9-2-2s0.9-2,2-2s2,0.9,2,2S38.1,15,37,15z" }),
        React.createElement("path", { d: "M34,25c0,4.96-4.04,9-9,9s-9-4.04-9-9s4.04-9,9-9S34,20.04,34,25z" })));
};
...
var Logo$1 = function (_a) {
    ...
    return (React.createElement(Flex, null,
        ...
        isAbsoluteUrl ? (React.createElement(StyledLink$1, { as: "a", href: href, "aria-label": "Bernardfinance home page" }, innerLogo)) : (React.createElement(StyledLink$1, { to: href, "aria-label": "Bernardfinance home page" }, innerLogo))));
};
...
var socials = [
    ...
    },
    {
        label: "Instagram",
        icon: "InstagramIcon",
        href: "https://www.instagram.com/bernard.finance",
    },
    {
        label: "Telegram",
        icon: "TelegramIcon",
...
var PanelFooter = function (_a) {
    var isPushed = _a.isPushed, pushNav = _a.pushNav; _a.toggleTheme; _a.isDark; var barrelPriceUsd = _a.barrelPriceUsd, bonesPriceUsd = _a.bonesPriceUsd, bernPriceUsd = _a.bernPriceUsd; _a.currentLang; _a.langs; _a.setLang; var bernPriceLink = _a.bernPriceLink, barrelPriceLink = _a.barrelPriceLink, bonesPriceLink = _a.bonesPriceLink;
    if (!isPushed) {
    ...
    return (React.createElement(Container$4, null,
        React.createElement(SocialEntry, null,
            bernPriceUsd ? (React.createElement(PriceLink, { href: bernPriceLink, target: "_blank" },
                React.createElement(Icon$N, { width: "20px", mr: "5px" }),
                React.createElement(Text, { color: "textSubtle", bold: true }, "$" + bernPriceUsd.toFixed(2)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
            barrelPriceUsd ? (React.createElement(PriceLink, { href: barrelPriceLink, target: "_blank" },
                React.createElement(Icon$M, { width: "20px", mr: "5px", ml: "5px" }),
                React.createElement(Text, { color: "textSubtle", bold: true }, "$" + barrelPriceUsd.toFixed(2)))) : (React.createElement(Skeleton, { width: 80, height: 24 })),
            bonesPriceUsd ? (React.createElement(PriceLink, { href: bonesPriceLink, target: "_blank" },
                React.createElement(Icon$L, { width: "20px", mr: "5px", ml: "5px" }),
                React.createElement(Text, { color: "textSubtle", bold: true }, "$" + bonesPriceUsd.toFixed(2)))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
        React.createElement(SocialEntry, null,
...
var Menu = function (_a) {
    var _b;
    var account = _a.account, login = _a.login, logout = _a.logout, isDark = _a.isDark, toggleTheme = _a.toggleTheme, langs = _a.langs, setLang = _a.setLang, currentLang = _a.currentLang, bernPriceUsd = _a.bernPriceUsd, bonesPriceUsd = _a.bonesPriceUsd, barrelPriceUsd = _a.barrelPriceUsd, links = _a.links, bernPriceLink = _a.bernPriceLink, barrelPriceLink = _a.barrelPriceLink, bonesPriceLink = _a.bonesPriceLink, profile = _a.profile, children = _a.children;
    ...
    return (React.createElement(Wrapper$1, null,
        ...
        React.createElement(BodyWrapper, null,
            React.createElement(Panel, { isPushed: isPushed, isMobile: isMobile, showMenu: showMenu, isDark: isDark, toggleTheme: toggleTheme, langs: langs, setLang: setLang, currentLang: currentLang, bernPriceUsd: bernPriceUsd, barrelPriceUsd: barrelPriceUsd, bonesPriceUsd: bonesPriceUsd, pushNav: setIsPushed, links: links, barrelPriceLink: barrelPriceLink, bonesPriceLink: bonesPriceLink, bernPriceLink: bernPriceLink }),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#191919", backgroundDisabled: "#3c3742", borderColor: "#383241", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#45346B", tertiary: "#45346B", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#5DCE80", card: "#27262cb3", gradients: {
        bubblegum: "linear-gradient(139.73deg, #27262cb3 0%, #548d65 100%)",
    } });
var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#191919", backgroundDisabled: "#3c3742", borderColor: "#383241", contrast: "#FFFFFF", invertedContrast: "#191326", input: "#45346B", tertiary: "#45346B", text: "#F4EEFF", textDisabled: "#666171", textSubtle: "#5DCE80", card: "#27262cb3", gradients: {
        bubblegum: "linear-gradient(139.73deg, #27262cb3 0%, #548d65 100%)",
    } });
...
export { Icon$4 as AddIcon, Alert, Icon$5 as ArrowBackIcon, Icon$6 as ArrowDownIcon, Icon$7 as ArrowDropDownIcon, Icon$8 as ArrowDropUpIcon, Icon$9 as ArrowForwardIcon, Icon$a as AutoRenewIcon, BackgroundImage, Icon$M as BarrelRoundIcon, GridLayout as BaseLayout, Icon$N as BernRoundIcon, Icon$b as BinanceIcon, Icon$2 as BlockIcon, Icon$L as BonesRoundIcon, Breadcrumbs, Icon$c as BunnyPlaceholderIcon, Button, ButtonMenu, ButtonMenuItem, Icon$e as CalculateIcon, Card, CardBody, CardFooter, CardHeader, CardRibbon, Icon$d as CardViewIcon, GridLayout$1 as CardsLayout, Checkbox, Icon as CheckmarkCircleIcon, Icon$f as CheckmarkIcon, Icon$g as ChevronDownIcon, Icon$h as ChevronLeftIcon, Icon$i as ChevronRightIcon, Icon$j as ChevronUpIcon, Icon$k as CloseIcon, Icon$l as CogIcon, Icon$m as CommunityIcon, Icon$n as CopyIcon, CopyToClipboard, Dropdown, Icon$1 as ErrorIcon, Icon$I as FarmIcon, Flex, Icon$w as GooseRoundIcon, Heading, Icon$o as HelpIcon, IconButton, Image, Icon$3 as InfoIcon, Input, Link, LinkExternal, Icon$p as ListViewIcon, Icon$q as LogoIcon, Icon$r as LogoRoundIcon, Menu, Icon$s as MinusIcon, Modal, ModalProvider, Icon$t as OpenNewIcon, Icon$v as PancakeRoundIcon, Icon$u as PancakesIcon, Icon$x as PrizeIcon, Progress, Icon$A as ProgressBunny, Radio, Icon$y as RemoveIcon, ResetCSS, Icon$E as SearchIcon, Skeleton, Spinner, Svg, Icon$F as SwapVertIcon, Icon$G as SyncAltIcon, Tag, Text, Icon$C as Ticket, Icon$K as TicketFillIcon, Icon$D as TicketRound, ToastContainer, Toggle, Icon$z as VerifiedIcon, Icon$J as VoteIcon, Icon$H as WarningIcon, Icon$B as Won, variants$1 as alertVariants, byTextAscending, byTextDescending, darkTheme as dark, darkColors, lightTheme as light, lightColors, makeRender, links as menuConfig, types as toastTypes, useMatchBreakpoints, useModal, useParticleBurst, useTable, useWalletModal };
